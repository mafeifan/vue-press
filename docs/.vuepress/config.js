    ...
    sidebar: [
      {
        ...
        children: [
          ...
          ['Docker/Docker-学习系列12-轻松实现-MySQL-主从同步', '12 轻松实现-MySQL-主从同步'],
          ['Docker/Docker-学习系列13-实现-基于pxc-的mysql-多节点主主同步', '13 实现基于pxc-的mysql-多节点主主同步'],
      ...
      },
      {
        ...
        children: [
          ...
          ['Jenkins/Jenkins2-学习系列18----凭证管理', '18 证管理'],
